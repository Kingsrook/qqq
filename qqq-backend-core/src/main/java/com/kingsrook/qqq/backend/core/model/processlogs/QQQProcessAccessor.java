...
/*******************************************************************************
 ** One-liner we can use to get a QQQProcess record, or just its id (which we often want).
 ** Will insert the record if it wasn't already there.
 ** Also uses in-memory cache table, so rather cheap for normal use-case.
 *******************************************************************************/
public class QQQProcessAccessor
{

   /*******************************************************************************
    **
    *******************************************************************************/
   public static QRecord getQQQProcessRecord(String processName) throws QException
   {
      /////////////////////////////
      // look in the cache table //
      /////////////////////////////
      GetInput getInput = new GetInput();
      getInput.setTableName(QQQProcessMetaDataProvider.QQQ_PROCESS_CACHE_TABLE_NAME);
    ...
    **
    *******************************************************************************/
   public static QRecord getQQQProcessRecord(Integer id) throws QException
   {
      /////////////////////////////
      // look in the cache table //
      /////////////////////////////
      ...
      if(getOutput.getRecord() == null)
      {
         ...
         sourceGetInput.setTableName(QQQProcess.TABLE_NAME);
    ...
    **
    *******************************************************************************/
   public static Integer getProcessId(String processName) throws QException
   {
      return (getQQQProcessRecord(processName).getValueInteger("id"));
   }
    ...
    **
    *******************************************************************************/
   public static String getProcessName(Integer id) throws QException
   {
      return (getQQQProcessRecord(id).getValueString("name"));
   }
